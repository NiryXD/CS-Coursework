...
Program Description: An interactable text adventure functioning through the use of pounters*/
        ...
        // The look object helps the user with the exits
        ...
        const Room *loadRooms(const string dungeonFilename) {
            ...
            for (size_t i = 0; i < roomCount; i++) {
                ...
                // using the stripWhitespace function to read in the information initalized in setInfo
                char direction;
                int index;
        ...
        // An error check for the first test case
        ...
        // An error check for the second test case
        ...
        while (true) {
            ...
            switch (input) {
                ...
                case 'n':
                case 'e':
                // Just the basic commands for the user. 
                // Containing the directions, quit, and look. 
                case 'w':
                    int nextRoomIndex = getExit(rooms[rightnow], input);
                    if (nextRoomIndex != -1) {
                        rightnow = nextRoomIndex;
